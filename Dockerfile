...
# Download Wan 2.2 I2V GGUF models (Q3_K_S — fits 24GB VRAM)
RUN comfy model download \
    --url "https://huggingface.co/QuantStack/Wan2.2-I2V-A14B-GGUF/resolve/main/HighNoise/Wan2.2-I2V-A14B-HighNoise-Q3_K_S.gguf" \
    --relative-path models/diffusion_models \
    --filename Wan2.2-I2V-A14B-HighNoise-Q3_K_S.gguf

RUN comfy model download \
    --url "https://huggingface.co/QuantStack/Wan2.2-I2V-A14B-GGUF/resolve/main/LowNoise/Wan2.2-I2V-A14B-LowNoise-Q3_K_S.gguf" \
    --relative-path models/diffusion_models \
